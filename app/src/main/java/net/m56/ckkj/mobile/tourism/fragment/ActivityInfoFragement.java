...
public class ActivityInfoFragement extends BaseFragment {
    ...
    @Override
    protected void initParams(View view, final Bundle savedInstanceState) {

        final ListView listview = (ListView) view.findViewById(R.id.listview);

        MultipartBody.Builder builder = new MultipartBody.Builder().setType(MultipartBody.FORM);
        builder.addFormDataPart("type", "新闻");

 ...
 * @ClassName: ${type_name}
 * @Description: 忘记密码验证手机
 * @date 2017/10/26 15:27
 */
public class ForgetPassActivity extends BaseActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case GET_CODE_SUCCES:
                    Toast.makeText(ForgetPassActivity.this, "获取验证码成功", Toast.LENGTH_SHORT).show();
                    break;
                case GET_CODE_FAIL:
                ...
                case SUBMIT_CODE_SUCCES:
                    isLooking = true;
                    Toast.makeText(ForgetPassActivity.this, "校验验证码成功", Toast.LENGTH_SHORT).show();
                    //必须获取校验成功,才可以继续下一个发送请求做注册过程
                    next();
                    break;
                case SUBMIT_CODE_FAIL:
                    isLooking = false;
                    Toast.makeText(ForgetPassActivity.this, "校验验证码失败", Toast.LENGTH_SHORT).show();
                    break;
                case KEEP_TIME_MINS:
    ...
    private void next() {
        ...
        intent = new Intent(getApplicationContext(), SetPassActivity.class);
